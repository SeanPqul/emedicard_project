            ...
            <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-200">
              ...
              <div className="p-8 space-y-6">
                ...
                {paymentData.paymentMethod === 'Maya' && paymentData.mayaCheckoutId && (
                  <div className="space-y-2">
                    <label htmlFor="mayaCheckoutId" className="block text-sm font-semibold text-teal-700 uppercase tracking-wide">
                      Maya Checkout ID
                    </label>
                    <input
                      type="text"
                      id="mayaCheckoutId"
                      value={paymentData.mayaCheckoutId}
                      readOnly
                      className="w-full px-4 py-3 border border-teal-200 rounded-xl text-teal-900 bg-teal-50 cursor-not-allowed font-mono font-medium focus:outline-none"
                    />
                  </div>
                )}
