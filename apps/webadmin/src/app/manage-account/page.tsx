            ...
            <div className="mb-6 sm:mb-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs text-gray-700 font-bold uppercase tracking-wide">Username</p>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs text-gray-700 font-bold uppercase tracking-wide">Role</p>
