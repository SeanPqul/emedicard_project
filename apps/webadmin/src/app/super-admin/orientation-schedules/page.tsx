      ...
      <main className="max-w-screen-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Orientation Schedule Manager</h1>
              <p className="text-gray-600 mt-1">Create and manage orientation schedules for applicants</p>
            </div>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="text-left px-6 py-4 font-semibold text-gray-700">Venue</th>
                  <th className="text-left px-6 py-4 font-semibold text-gray-700">Instructor</th>
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                {schedules && (schedules as any[]).map((schedule: Schedule) => {
                  ...
                  return (
                    <tr key={schedule._id} className={`hover:bg-gray-50 transition-colors ${isPast ? "opacity-60" : ""}`}>
