        ...
        {selectedCategoryId && requirementsByCategory && (
          <View style={styles.requirementsContainer}>
            <Text style={styles.sectionTitle}>
              Required Documents for {getHealthCardTypeName(typeof requirementsByCategory.jobCategory === 'string' ? requirementsByCategory.jobCategory : requirementsByCategory.jobCategory?.name || 'Health Card')}
            </Text>
