          ...
          <View style={styles.notificationFooter}>
            {notification.formsId && (
              <View style={styles.actionContainer}>
                ...
                <Text style={[styles.notificationAction, { color }]}>
                  Tap to view details
                </Text>
              </View>
            )}
      ...
      switch (selectedCategory) {
        case 'Unread':
          return {
            ...
            title: 'All Caught Up!',
            subtitle: "You've read all your notifications. Great job staying organized!"
          };
        case 'Applications':
          return {
            icon: 'document-text-outline',
            title: 'No Application Updates',
            subtitle: 'Your application notifications will appear here when available.'
          };
        case 'Payments':
          return {
            icon: 'card-outline',
            title: 'No Payment Notifications',
            subtitle: 'Payment confirmations and updates will be shown here.'
          };
        case 'Orientations':
          return {
            icon: 'school-outline',
            title: 'No Orientation Notifications',
            subtitle: 'Orientation schedules and updates will appear here.'
          };
        default:
          return {
            icon: 'notifications-outline',
            title: 'No Notifications',
            subtitle: "You're all caught up! No notifications yet."
          };
      }
    };
