...
import { FeedbackSystem, useFeedback } from '../../components/';
...
import { transformRequirements } from '../../utils/application/requirementsMapper';
import { STEP_TITLES } from '../../constants/application';
...
export default function ApplyScreen() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      setJobCategoriesData(jobCategories.jobCategories || []);
      setUserProfile(users.data.currentUser || null);
      
      // Initialize form with data
      initializeForm(jobCategories.jobCategories || [], users.data.currentUser);
  ...
  }, [jobCategories.jobCategories, jobCategories.isLoading, users.data.currentUser, initializeForm]);
